...
/***/ function(module, exports, __webpack_require__) {
	...
	var Diagnosis = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.state.showStatus ? React.createElement(PatientStatus, null) : null
	    );
	  }
	});

	var PatientStatus = React.createClass({
	  displayName: 'PatientStatus',
	...
	ReactDOM.render(React.createElement(Diagnosis, null), document.getElementById('diagnosis'));
