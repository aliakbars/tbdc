	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'input-group' },
	          React.createElement('input', { type: 'text', className: 'form-control', id: '', name: 'dosage[]', placeholder: '' }),
	          React.createElement(
	            'span',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'select',
	          { className: 'form-control', name: 'freq_day[]' },
	          options
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          'select',
	          { className: 'form-control', name: 'freq_week[]' },
	          freq_week
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', className: 'form-control', id: '', name: 'start_date[]', placeholder: 'YYYY-MM-DD' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'form-group col-md-2' },
	        ...
	        React.createElement('input', { type: 'text', className: 'form-control', id: '', name: 'end_date[]', placeholder: 'YYYY-MM-DD' })
	      ),
	      deleteButton
	    );
	  }
